...
module.exports = async function computeCampaignAnalysis(
  ...
  const validatedKnowledgeElementsByTube = await knowledgeElementRepository.findValidatedTargetedGroupedByTubesForUsers(sharedParticipationsUserIdsAndDates, targetProfile);
